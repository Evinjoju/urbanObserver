      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div className="border-2 border-white rounded-lg p-8 text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-400">/ forever</p>
          </div>
        ...
        {/* Premium Plan */}
        <div className="border-2 border-white rounded-lg p-8 text-center relative">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-400">/ {isYearly ? "year" : "month"}</p>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <span className={`font-bold ${isYearly ? "text-white" : "text-gray-400"}`}>
              YEARLY PRICING
            </span>
            <button
              onClick={() => setIsYearly(!isYearly)}
              className="relative w-14 h-8 bg-gray-400 rounded-full transition-all duration-300"
            >
              <div
